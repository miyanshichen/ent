<template>
  <div class="login">
    <div class="form-box">
      <div class="logo mc-size32 white-text mc-text-center">找回密码</div>
      <el-form :model="regForm">
        ...
        ></el-form-item>
        <el-button type="primary" class="mc-w-100 mc-mtb-20">提交</el-button>
        <div class="mc-flex mc-flex-justify-between">
          <router-link to="/login" class="white-text">登录</router-link>
        </div>
      </el-form>
    </div>
  </div>
