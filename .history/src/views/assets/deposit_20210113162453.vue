<template>
  <div>
    ...
    <div class="container mc-mt-20">
      <el-row :gutter="10">
        <el-col :span="24"><div class="grid-content bg-purple hidden-xs-only">
            <div class="title mc-flex mc-flex-justify-between">
              <span>充币记录</span>
              <router-link to="/finance/deposit/logs">查看更多</router-link>
            </div>
          </div></el-col >
      </el-row>
    </div>
