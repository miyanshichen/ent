        ...
        <el-col :span="24">
          <div class="grid-content bg-purple hidden-xs-only">
            ...
            <el-table :data="logsData">
              ...
              <el-table-column label="充币地址" prop="number"></el-table-column>
              <el-table-column label="充币地址" prop="txid"></el-table-column>
              <el-table-column label="充币地址" prop="statusName"></el-table-column>
              <el-table-column label="充币地址" prop="time" align="right"></el-table-column>
            </el-table>
          </div>
        </el-col>
      </el-row>
