  ...
  <div>
    ...
    <el-dialog class="psd-dialog" :visible.sync="psdDialog" title="登录密码重置">
      <el-form :model="psdForm">
        ...
        ></el-form-item>
        <el-form-item>
          <mc-input title="短信验证码" :val="psdForm.code" :code="true"></mc-input
        ></el-form-item>
      </el-form>
      <el-button type="primary" class="mc-w-100">提交</el-button>
    </el-dialog>
    <el-dialog class="psd-dialog" :visible.sync="tradeDialog" title="交易密码重置">
      <el-form :model="psdForm">
        <el-form-item>
          <mc-input
            title="密码"
            :val="tradeForm.password"
            type="password"
          ></mc-input>
        </el-form-item>
        <el-form-item>
