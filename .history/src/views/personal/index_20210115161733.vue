  ...
  <div>
    <public-header>
      <div
        to
        slot="header-r"
        class="main-text mc-cursor-default"
        @click="logOut()"
      >
        退出
      </div>
      ...
      <el-row :gutter="20">
        ...
        <el-col :xs="24" :span="12" class="mc-mb-20">
          <el-card>
            <div class="mc-flex mc-flex-justify-between">
              <span>语言</span
              ><span class="mc-cursor-default" @click="langDialog = true"
                >设置</span
              >
            </div>
          </el-card>
    ...
    >
      ...
      <el-button type="primary" class="mc-w-100" @click="psdSub()"
        >提交</el-button
      >
    </el-dialog>
    <el-dialog
    ...
    >
      ...
      <el-button type="primary" class="mc-w-100" @click="tradeSub()"
        >提交</el-button
      >
    </el-dialog>
    <el-dialog :visible.sync="langDialog" title="语言设置">
      <div><el-radio v-model="radio" label="1">备选项</el-radio>
      <el-radio v-model="radio" label="2">备选项</el-radio></div>
      <div class="mc-flex mc-mt-20 ">
        <el-button type="info" class="mc-flex-1 mc-mr-20">取消</el-button>
        <el-button type="primary" class="mc-flex-1 mc-mr-20">提交</el-button>
      </div>
    </el-dialog>
  </div>
</template>
