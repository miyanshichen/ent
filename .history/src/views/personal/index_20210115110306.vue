  ...
  <div>
      ...
      <el-form :model="psdForm" ref="psdForm" :rules="psdRules">
        <el-form-item>
          <mc-input
            ...
            type="password"
             @input-change="(val) => {psdForm.password = val}"
          ></mc-input>
        </el-form-item>
        <el-form-item>
          <mc-input
            ...
            type="password"
             @input-change="(val) => {psdForm.password2 = val}"
          ></mc-input
        ></el-form-item>
        <el-form-item>
          <mc-input title="短信验证码" :val="psdForm.vcode" :code="true"
             @input-change="(val) => {psdForm.vcode = val}"></mc-input
        ></el-form-item>
      </el-form>
    ...
    <el-dialog class="psd-dialog" :visible.sync="tradeDialog" title="交易密码设置">
      <el-form :model="tradeForm" >
        ...
        ></el-form-item>
        <el-form-item>
          <mc-input title="短信验证码" :val="tradeForm.code" :code="true"></mc-input
        ></el-form-item>
      </el-form>
      <el-button type="primary" class="mc-w-100">提交</el-button>
    </el-dialog>
...
export default {
  ...
  data() {
    return {
      ...
      psdRules: {
        password: [{requred: true, validator: passwordCheck, trigger: 'blur'}],
        password2: [{requred: true, validator: password2Check, trigger: 'blur'}],
        password2: [{requred: true, validator: passwordCheck, trigger: 'blur'}],
      },
      tradeForm: {
        second_password: "",
        second_password2: "",
