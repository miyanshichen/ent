<template>
  <div>
      ...
      <el-col :xs="24" :span="12" class="mc-mb-20">
        <el-card>
          <div class="mc-flex mc-flex-justify-between">
            <span>登录密码</span>
            <span class="mc-cursor-default">重置</span>
          </div>
        </el-card>
      </el-col>
    ...
    <el-dialog class="psd-dialog" :visible.sync="psdDialog" title="密码重置">
      <el-form :model="psdForm">
        <el-form-item>
          <mc-input title="新密码" :val="psdForm.password" type="password"></mc-input>
        </el-form-item>
        <el-form-item>
          <mc-input title="新密码" :val="psdForm.password2" type="password"></mc-input></el-form-item>
        <el-form-item>
          <mc-input title="新密码" :val="psdForm.code" :code="true"></mc-input></el-form-item>
      </el-form>
    </el-dialog>
  </div>
</template>
