  ...
  <div class="login">
    <div class="form-box">
      ...
      <el-form :model="regForm" ref="refForm" :rules="regRules">
        <el-form-item prop="name"><el-input v-model="regForm.name"></el-input></el-form-item>
        <el-form-item prop="name"><mc-input :val="regForm.name" title="账号"></mc-input></el-form-item>
