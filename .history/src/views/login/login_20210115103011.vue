  ...
  <div class="login">
    <div class="form-box">
      ...
      <el-form :model="loginForm" ref="loginForm" :rules="loginRules">
        <el-form-item prop="account"><mc-input :val="loginForm.account" title="账号"></mc-input></el-form-item>
      ...
      this.$refs.loginForm.validate(async valid => {
        if (async) {
          if (this.loginSwitch) {
            ...
            await this.$axios.post(this.$https.api + '/signIn', this.loginForm).then()
          }
        }
      })
    }
