<template>
  <div class="mc-input">
    ...
    <el-input v-model="value" :type="passSwitch ? 'text' : 'password'" @focus="inputFocus()" @blur="inputBlur()" v-if="type === 'password'">
      <span slot="suffix" class="mc-size24 iconfont mc-mt-5 mc-display-in-block" :class="passSwitch ? 'icon-yanjing_xianshi_o': 'icon-yanjing_yincang_o'" @click="passSwitch = !passSwitch"></span>
    </el-input>
  </div>
</template>
